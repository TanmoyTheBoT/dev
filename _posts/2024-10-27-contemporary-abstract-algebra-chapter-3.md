...
- **Example**: The group $\mathbb{Z}$ of integers under addition has infinite order, while $U(10) = \{1, 3, 7, 9\}$ under multiplication modulo 10 has order 4.

#### 2. **Order of an Element**

- The order of an element $g$ in a group $G$ is the smallest positive integer $n$ such that $g^n = e$, where $e$ is the identity element. If no such integer exists, $g$ has infinite order, denoted $\vert g \vert$.
...
1. **Example 1**: *Order of Elements in $U(15)$*  
   $U(15) = \{1, 2, 4, 7, 8, 11, 13, 14\}$ under multiplication modulo 15. This group has order 8.
...
1. **Example 2**: *Order of Elements in $Z_{10}$*
   In the group $Z_{10}$ under addition modulo 10:
...
3. **Theorem 3.3**: *Finite Subgroup Test*
   ...
   - **Proof**:
     ...
     - Since $H$ is finite, the sequence $a, a^2, a^3, \ldots$ must eventually repeat. Therefore, there exists $m, n$ such that $a^m = a^n$ with $m > n$, implying $a^{m-n} = e$.
     - Since $H$ is closed and finite, this repetition shows $a^{-1} \in H$, making $H$ a subgroup of $G$.
...
1. **Example 4**: *Subgroup of Abelian Group $G$ with Condition $x^2 = e$*
   Let $G$ be an Abelian group with identity $e$, and define $H = \{ x \in G \mid x^2 = e \}$.
...
2. **Example 5**: *Subgroup of Squares in $G$*
   Let $G$ be an Abelian group under multiplication with identity $e$, and let $H = \{ x^2 \mid x \in G \}$, representing the set of all squares in $G$.
   - **Application of One-Step Subgroup Test**:
...
3. **Example 6**: *Subgroup of Elements with Finite Order in Abelian Group $G$*
   Let $G$ be an Abelian group, and let $H = \{ x \in G \mid \vert x\vert  \text{ is finite} \}$, where $\vert x\vert $ denotes the order of $x$.
   - **Application of Two-Step Subgroup Test**:
     ...
     - Furthermore, $a^{-1}$ also has finite order, as $(a^{-1})^m = e$, so $a^{-1} \in H$.
     - By Theorem 3.2, $H$ is a subgroup of $G$.

4. **Example 7**: *Subgroup $HK$ in Abelian Group $G$*
   Let $G$ be an Abelian group, and let $H$ and $K$ be subgroups of $G$. Define $HK = \{ hk \mid h \in H, k \in K \}$.
   - **Application of Two-Step Subgroup Test**:
...
1. **Theorem 3.4**: *$\langle a \rangle$ Is a Subgroup*
   - **Statement**: Let $G$ be a group, and let $a$ be any element of $G$. Then, the set $\langle a \rangle = \{ a^n \mid n \in \mathbb{Z} \}$ is a subgroup of $G$.
   - **Proof**:
...
2. **Theorem 3.5**: *Center Is a Subgroup*
   ...
   - **Proof**:
     ...
     - Let $a, b \in Z(G)$; then for any $x \in G$:
       ...
       $$
       showing $ab \in Z(G)$.
     - Now, for any $a \in Z(G)$, $a^{-1} \in Z(G)$ since $ax = xa \Rightarrow a^{-1}x = xa^{-1}$.
...
3. **Theorem 3.6**: *Centralizer $C(a)$ Is a Subgroup*
   ...
   - **Proof**:
     ...
     - If $x \in C(a)$, then $x^{-1}a = ax^{-1}$, so $x^{-1} \in C(a)$.
...
1. **Example 8**: *Non-Subgroup Verification in $G$*
   ...
   - Define $H = \{ x \in G \mid x = 1 \text{ or } x \text{ is irrational} \}$.
...
2. **Example 9**: *Cyclic Subgroup in $U(10)$*
   Consider the group $U(10) = \{1, 3, 7, 9\}$ under multiplication modulo 10.
   - Let $\langle 3 \rangle$ represent the cyclic subgroup generated by 3.
     - Compute: $3^1 = 3$, $3^2 = 9$, $3^3 = 7$, $3^4 = 1$.
   - Therefore, $\langle 3 \rangle = \{3, 9, 7, 1\} = U(10)$, which means $U(10)$ is cyclic with 3 as a generator.

3. **Example 10**: *Cyclic Subgroup in $Z_{10}$*
   In the group $Z_{10}$ (integers under addition modulo 10), find the cyclic subgroup generated by 2.
   - Let $\langle 2 \rangle = \{ 2n \mid n \in \mathbb{Z} \}$ under addition modulo 10.
     - Compute: $2 \cdot 1 = 2$, $2 \cdot 2 = 4$, $2 \cdot 3 = 6$, $2 \cdot 4 = 8$, $2 \cdot 5 = 0$.
   - Thus, $\langle 2 \rangle = \{0, 2, 4, 6, 8\}$, which is a cyclic subgroup of $Z_{10}$.
...
4. **Example 11**: *Subgroup $D_3$ of $D_6$ Using Symmetry*
   ...
   - Define $D_3 = \{R_0, R_{120}, R_{240}, F, R_{120}F, R_{240}F\}$, where $R_\theta$ denotes rotation by $\theta$ degrees, and $F$ denotes a reflection.
...
5. **Example 12**: *Center of the Dihedral Group $D_n$*
   ...
   - If $n$ is even, the center $Z(D_n) = \{R_0, R_{180}\}$, where $R_{180}$ is rotation by 180 degrees.
   - If $n$ is odd, the center $Z(D_n) = \{R_0\}$.
...
6. **Example 13**: *Centralizer in $D_4$*
   ...
   - For example, the centralizer of $R_{90}$ (rotation by 90 degrees) in $D_4$ is $C(R_{90}) = \{ R_0, R_{90}, R_{180}, R_{270} \}$, as these rotations commute with $R_{90}$.
   - Similarly, the centralizer of a reflection $H$ in $D_4$ is $C(H) = \{ R_0, H, R_{180}, V \}$, as these elements commute with $H$.
